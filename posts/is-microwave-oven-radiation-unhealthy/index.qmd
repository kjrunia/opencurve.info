...
![Pripyat, near Chernobyl, Ukraine. When we hear "radiation", we may associate it with the [Chernobyl disaster](https://en.wikipedia.org/wiki/Chernobyl_disaster). That is absolutely not at all what microwave oven radiation is.](pripyat-1366159_1280.jpg){#fig-pripyat fig-alt="Eerie interior view of an abandoned hospital hallway in Pripyat near Chernobyl with peeling paint, debris on the floor, and open window frames."}
:::
...
![Bananas naturally possess radioactivity. Our species can easily handle this background radiation. (Photo by Pixabay).](accident-994009_1280.jpg){fig-alt="A heavy black leather boot about to step on a discarded yellow banana peel lying on a concrete floor."}
:::
...
::: {style="width: 80%; margin: 1.5rem auto;"}
![The process of ionisation: an intact neutral atom (1) is struck by high-energy radiation (2), stripping away its orbital electrons and leaving behind a bare ion or nucleus (3).](ionisation%20diagram.jpg){#fig-ionisation fig-alt="Diagram in three steps showing an orange circular atom, high-energy purple particles stripping away its electron shell, and leaving a bare positive nucleus behind."}
:::
...
::: {style="width: 45%; margin: 1.5rem auto;"}
![Max Planck in 1933. Nobel laureate and one of the founding fathers of quantum mechanics.](Max_Planck_1933.jpg){#fig-planck fig-alt="Historical sepia photographic portrait of German theoretical physicist Max Planck wearing round eyeglasses, a wing collar, and a bow tie."}
:::
...
::: {style="width: 80%; margin: 1.5rem auto;"}
![Vitamins are broken down by heat, not by microwave radiation itself.](flame-871136_1280.jpg){#fig-flame fig-alt="Macro close-up photograph of vivid blue gas stove flames licking against the metallic base of a cooking pan."}
:::
...
::: {style="width: 45%; float: right; margin: 0 0 1rem 1.5rem;"}
![Protect yourself against solar UV rays with sunscreen; high-energy ultraviolet light is genuinely ionising.](canoeing-1185309_1280.jpg){fig-alt="Rear-angle perspective photograph of a shirtless man rowing an aluminium canoe down a wide, sunlit river flanked by lush green trees."}
:::
